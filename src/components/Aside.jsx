...
export default function AsideLeft(lang) {
  ...
  return (
    <aside className="block  bg-slate-700 w-1/4 font-bold justify-between">
      <div className="block justify-between text-black p-2">
      ...
      <div className="bg-orange-700 p-4  border-black border-2 dark:text-white dark:bg-black">
        <div className="p-2 dark:text-white  border-black border-2 dark:bg-black">
          {lang ? (
          ...
          <div className="flex  shadow-2xl shadow-cyan-500 justify-between pb-2">
            <button
              value={"Menos de 20$"}
        ...
        <div>
          <div className="bg-orange-700 border-black border-2 p-2 dark:text-white dark:bg-black">
